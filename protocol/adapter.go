...
func (a *Adapter) SetGlobalConfig(meta schema.Meta, data map[string]any) error {
	...
	if err := a.pluginSchema.SetGlobalConfig(meta, data); err != nil {
		a.logger.Debug(fmt.Sprintf("SetGlobalConfig error: %s", err))
		return err
	}
	return nil
}
func (a *Adapter) SetSiteConfig(site string, meta schema.Meta, data map[string]any) error {
	...
	if err := a.pluginSchema.SetSiteConfig(site, meta, data); err != nil {
...
func (a *Adapter) SetSiteComponentConfig(site string, component string, meta schema.Meta, data map[string]any) error {
	...
	if err := a.pluginSchema.SetSiteComponentConfig(site, component, meta, data); err != nil {
...
func (a *Adapter) SetSiteEndpointConfig(site string, name string, meta schema.Meta, data map[string]any) error {
	...
	if err := a.pluginSchema.SetSiteEndpointConfig(site, name, meta, data); err != nil {
...
func (a *Adapter) SetComponentConfig(component string, version string, meta schema.Meta, data map[string]any) error {
	...
	if err := a.pluginSchema.SetComponentConfig(component, version, meta, data); err != nil {
...
func (a *Adapter) SetComponentEndpointsConfig(component string, meta schema.Meta, endpoints map[string]string) error {
	if a.pluginSchema.SetComponentEndpointsConfig != nil {
		if err := a.pluginSchema.SetComponentEndpointsConfig(component, meta, endpoints); err != nil {
